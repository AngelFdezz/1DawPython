""" 2. Programa que reciba una url y el nombre de una etiqueta html. Si la url es válida debe mostrar por la pantalla
el contenido de cada etiqueta.
...
if len(sys.argv) != 3:
    print("Tiene que introducir DOS parámetros. ")
    sys.exit(1)
