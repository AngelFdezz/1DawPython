...
if __name__ == '__main__':
    pr1 = Question("Pregunta1", "Este es el enunciado de la pregunta 1.",
                   ([("Respuesta 1", 1), ("Respuesta 2", -0.25), ("Respuesta 3", -0.50), ("Respuesta 4", -0.75)]), 1)
    pr1.print_question()
    pr1.user_answer()

    pr2 = Question("Pregunta2",
                   "Este es el enunciado de la pregunta 2.",
                   ([("Respuesta 1", -0.25), ("Respuesta 2", 1), ("Respuesta 3", -0.25), ("Respuesta 4", -0.50)]), 1)
    pr2.print_question()
    pr2.user_answer()

    pr3 = Question("Pregunta3",
                   "Este es el enunciado de la pregunta 3.",
                   ([("Respuesta 1", -0.75), ("Respuesta 2", -0.25), ("Respuesta 3", 1), ("Respuesta 4", -0.25)]), 1)
    pr3.print_question()
    pr3.user_answer()

    pr4 = Question("Pregunta4",
                   "Este es el enunciado de la pregunta 4.",
                   ([("Respuesta 1", -0.75), ("Respuesta 2", -0.50), ("Respuesta 3", -0.25), ("Respuesta 4", 1)]), 1)
    pr4.print_question()
    pr4.user_answer()

    pr5 = Question("Pregunta5",
                   "Este es el enunciado de la pregunta 5.",
                   ([("Respuesta 1", 1), ("Respuesta 2", -0.25), ("Respuesta 3", -0.75), ("Respuesta 4", -0.50)]), 1)
    pr5.print_question()
    pr5.user_answer()
